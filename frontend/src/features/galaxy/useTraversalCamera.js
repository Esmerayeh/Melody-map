...
const OVERVIEW    = { x: 0, y: 16, z: 88 }   // recenter framing, scaled to the SPREAD_SCALE galaxy

// Bounded volume: with SPREAD_SCALE=4.0 the galaxy lives within ~112 units, so
...
// SOFT_START (past the galaxy, past OrbitControls maxDistance 240) and fully
// engages by MAX_RADIUS, easing the user back rather than flinging into void.
const SOFT_START  = 260
